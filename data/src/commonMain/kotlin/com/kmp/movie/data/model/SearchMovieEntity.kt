...
data class SearchMovieEntity(
    val page: Int,
    val results: List<SearchMovieDateEntity>,
    @SerialName("total_pages")
    val totalPages: Int,
    @SerialName("total_results")
    val totalResults: Int,
): DataMapper<SearchMovie> {
    override fun toDomain(): SearchMovie {
        return SearchMovie(
...
@Serializable
data class SearchMovieDateEntity(
    val adult: Boolean,
    ...
    val voteCount: Int
): DataMapper<SearchMovieData> {
    override fun toDomain(): SearchMovieData {
